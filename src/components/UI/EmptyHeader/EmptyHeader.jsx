        ...
        <header className="header">
            ...
            <Link to={'/auth'}>
                <div className="header__auth">
                        {/*<img src="../../../public/assets/icons/profile.svg" alt="auth icon"/>*/}
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="11.5791" cy="7.27803" r="4.77803" stroke="#200E32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
